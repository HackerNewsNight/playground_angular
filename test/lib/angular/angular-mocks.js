 ...
 *
 * <pre>
 *   beerAppDev = angular.module('beerAppDev', ['beerApp', 'ngMockE2E']);
 *   beerAppDev.run(function($httpBackend) {
...
window.jasmine && (function(window) {
   ...
   * <pre>
   *
   *   angular.module('beerApplicationModule', [])
   *       .value('mode', 'app')
   ...
   *     beforeEach(module('beerApplicationModule'));
   *
   *
